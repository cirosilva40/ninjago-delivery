      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-white/5 border-white/10 p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-white mb-2">Vincular Conta</h1>
            <p className="text-slate-400">
              Insira seu telefone cadastrado na pizzaria para vincular sua conta.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Use o mesmo telefone informado no cadastro da pizzaria
              </p>
            </div>

            <Button 
              onClick={vincularEntregador}
              disabled={!codigoVinculo || loading}
              className="w-full h-12 bg-gradient-to-r from-orange-500 to-red-600 text-lg"
            >
            ...
            <div className="text-center pt-4 border-t border-white/10">
              <p className="text-slate-500 text-sm mb-2">Logado como:</p>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-14 h-14 rounded-xl bg-white/10 flex items-center justify-center">
                      {pagamentoConfig[selectedEntrega.forma_pagamento] 
                        ? React.createElement(pagamentoConfig[selectedEntrega.forma_pagamento].icon, {
                            className: `w-8 h-8 ${pagamentoConfig[selectedEntrega.forma_pagamento].color}`
                          })
                    ...
                    <div className="mt-4 p-3 rounded-lg bg-yellow-500/20 border border-yellow-500/30">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-lg font-bold text-yellow-400">R$ {selectedEntrega.troco_para?.toFixed(2)}</p>
                        </div>
                      </div>
                      <div className="mt-2 pt-2 border-t border-yellow-500/20 flex items-center justify-between">
                        ...
                        <span className="text-xl font-bold text-yellow-400">
                          R$ {(selectedEntrega.troco_para - selectedEntrega.valor_pedido).toFixed(2)}
                        </span>
                      </div>
                    </div>
                  )}
